<?php
  ...
  $go = isset($go)?$go:'donate_update';
  $del = isset($del)?$del:'donate_delete';
  ...
  */
  ...
  $commentDao = new CommentDao('donate_comment');
  ...
  $reply_comment = 'donate_recommend_comment';
  $commentTable = 'donate_comment';
        ...
        <div class="wrap">
            <ul class="l-row">
                <li class="l-col">
                      ...
                      <?php foreach($datas as $data): ?>
                        ...
                        <div class='editor-text'>
                          ...
                          <?php if($nickname == $data['nickname']):?>
                            <input type='button' onclick="check3()" value='삭제'  method="post" class='btn btn-primary' style='float:right'>
                            <input type='button' onclick="location.href='recommend_form?url=<?=$url?>&go=<?=$go?>&num=<?=$num?>&page=<?=$currentPage?>&title=<?=$data['title']?>&thema=<?=$thema?>'" value='수정'  method="post" class='btn btn-primary' style='float:right;margin-right:5px;'>
                            <?php endif?>
                          </div>
                            <h2><?=$data['title']?></h2>
                    ...
                    <form  action="donate_comment"   enctype='multipart/form-data' >
                            ...
                            <div class='text-box'>
                              ...
                              <?php endif?>
                              <input type='button' value='전체글' class='btn btn-primary' onclick="location.href='recommend_board.php?page=1&thema=<?=$data['thema']?>'">
                              <br><br>
                            </div>
                    </form>
                    <?php endforeach?>
                            ...
                            <li  class="list-group-item" >
                              <article class="row" >
                               ...
                               <!---->
                                  ...
                                  <div id='reply_box<?=$count?>' style='display:none;overflow-y:scroll;max-height:500px;'>
                                    <?php
                              ...
                              <?php endforeach ?>
                                ...
                                <div style='text-align:center;'>
                                  <?php if($currentPage > PAGE_LINK ):?>
                                    <a href='?num=<?=$num?>&page=<?=$currentPage-5?>'>< </a>
                                  <?php endif?>

                                  <?php for($i=$firstLink ; $i<=$lastLink ; $i++): ?>
                                    <a href='?num=<?=$num?>&page=<?=$i?>'><?= $i ?> </a>
                                  <?php endfor?>
