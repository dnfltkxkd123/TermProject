      ...
      <div class="row">
          <div class="panel panel-default widget">
              ...
              <div class="panel-body">
                ...
                <input type='button' onclick="location.href='openBoard_register_form?url<?=$url?>&form=update&num=<?=$num?>&page=<?=$currentPage?>&title=<?=$title?>'" value='수정'  method="post" class='btn btn-primary' style='float:right;margin-right:5px;'>
                <?php endif?>
                <br>
                <div style='overflow: auto;'><?=$text?></div>
                  
                  <form  action="comment"   enctype='multipart/form-data'>
                    <div class=' text margin_top'>
                      ...
                      <?php endif?>
                      <input type='button' value='전체글' class='btn btn-primary' onclick="location.href='openBoard?page=1'">
                      <br><br>
                    </div>
                </form>
                                      ...
                                      <div class="comment-post" style='overflow:auto;'><!-- -->
                                        ...
                                        <div class="action">
                                          ...
                                          <?php if($nickname == $comment['nickname']):?>
                                            ...
                                            <button type="button" class="btn btn-danger btn-xs" title="Delete" onclick="location.href = 'deleteComment?count=<?=$comment['count']?>&table=comment'">
                                        ...
                                        <div id='update_comment<?=$count?>' style='margin-top:5px;display:none'>
                                          <form action='comment_update' enctype='multipart/form-data'>
