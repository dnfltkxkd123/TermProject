<?php
  ...
  $replyDao -> insertReply($count,$text,$nickname);
  $limit = $replyDao ->getAllCount();
  ?>
  <script>
    
  </script>
  <?php
  $replyComment = $replyDao -> getReply3($limit-1);
?>    
<li  class="list-group-item reply reply<?=$count?> sub<?=$subCount?>" style='border-color:rgba(0,0,0,0);' >
  <script>
  </script>
